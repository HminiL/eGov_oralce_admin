...
<form action="${contextPath}/orders/order" method="post">
  ...
  <div class="container">
    <label for="orderId"><b><b>orderId</b></b></label>
    ...
    <input type="text" placeholder="Enter Id" name="bookId" >
    
    <label for="orderPrice"><b>orderPrice</b></label>
    <input type="text" placeholder="Enter price" name="orderPrice" required>
    
    <label for="orderDate"><b>orderDate</b></label>
    <input type="text" placeholder="Enter date" name="orderDate" required>
